    ...
    gov_main_layout(
      gov_row(
        column(
          ...
          h2("Give us feedback"),
          p("This dashboard is a new service that we are developing. If you have any feedback or suggestions for improvements, please submit them using our ",
          a(
          ...
          p("The data used to produce the dashboard, along with methodological information can be found on ",
